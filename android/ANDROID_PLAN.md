...
| Phase 5 | complete — Daily Challenge/deep links, Glance widget and local reminders all build- and emulator-verified | current working tree (uncommitted) | none; carry its architecture forward when Phase 8 adds launch-sequence gating. |
